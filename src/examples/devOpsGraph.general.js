const devOpsGraph = {
  ...
  nodes: [
    ...
    },
    {
      ...
      details: '- A monitoração de aplicações em produção opera de forma continuada.  \n- Dados de disponibilidade, carga e performance são regularmente repassados para os times de desenvolvimento.',
    },
    {
      id: 804,
      level: 4,
      ...
      details: '- A monitoração de aplicações incorpora práticas de telemetria.  \n- Experimentos com telemetria coletam dados de uso para gerar aprendizados de negócio para os times de desenvolvimento.',
    },
    {
      id: 805,
      level: 5,
      ...
      details: '- Monitoração de uso integra o trabalho dos times de desenvolvimento, qualidade e operações.  \n- Novos requisitos de negócio são guiados pelo uso da aplicação em produção.  \n-_Feedbacks_ de monitoração plenamente acionáveis para os times',
    },
  ],
  edges: [
    ...
    { id: 50, from: 801, to: 802 },
    { id: 51, from: 802, to: 803 },
    { id: 52, from: 202, to: 803 },
    { id: 53, from: 803, to: 804 },
    { id: 54, from: 803, to: 704 },
    { id: 55, from: 804, to: 805 },
  ],
};
